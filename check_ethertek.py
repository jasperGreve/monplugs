...
helper.parser.add_option("-c", help="Snmp Comunity", dest="community", default='publicfreewire')

helper.parse_arguments()
mib='/usr/share/mibs/site/ETHERTEK-MIB.txt'
...
#m=Manager(helper.options.host,helper.options.community,int(helper.options.version))
#m = Manager(host=helper.options.host,
#      version=3,
#      secname="ethertec",
#      authpassword="publicfreewire")

values={'rms100voltmeter1value':'','rms100voltmeter2value':''}

formatstring='100relay1state %s'
content=m.rms100relay1state
